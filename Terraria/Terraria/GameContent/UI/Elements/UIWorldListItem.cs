...
namespace Terraria.GameContent.UI.Elements
{
    internal class UIWorldListItem : UIPanel
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            string text1 = this._data.IsExpertMode ? "Expert" : "Normal";
            float num1 = Main.fontMouseText.MeasureString(text1).X;
            float x2 = (float)((double)width1 * 0.5 - (double)num1 * 0.5);
            Utils.DrawBorderString(spriteBatch, text1, position + new Vector2(x2, 3f), this._data.IsExpertMode ? new Color(217, 143, 244) : Color.White, 1f, 0.0f, 0.0f, -1);
            ...
            float x3 = (float)((double)width2 * 0.5 - (double)num2 * 0.5);
            ...
            float x4 = (float)((double)width3 * 0.5 - (double)num3 * 0.5);
