...
namespace Terraria.GameContent.Biomes
{
    internal class MarbleBiome : MicroBiome
    {
        ...
        public override bool Place(Point origin, StructureMap structures)
        {
            ...
            float num9 = (float)((double)Utils.NextFloat(GenBase._random) * 2.0 - 1.0);
            float num10 = (float)((double)Utils.NextFloat(GenBase._random) * 2.0 - 1.0);
            float num11 = (float)((double)Utils.NextFloat(GenBase._random) * 2.0 - 1.0);
            float num12 = 0.0f;
            for (int index1 = 0; index1 <= num1; ++index1)
            {
