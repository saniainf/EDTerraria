...
namespace Terraria.ID
{
    public class TileID
    {
        ...
        public static class Sets
        {
            ...
            public static bool[] GrassSpecial = Factory.CreateBoolSet(new int[2] { 70, 60 });
            ...
            public static bool[] Leaves = Factory.CreateBoolSet(new int[2] { 384, 192 });
            public static bool[] GeneralPlacementTiles = Factory.CreateBoolSet(1 != 0, 225, 41, 43, 44, 226, 203, 112, 25, 70, 151, 21, 31);
            public static bool[] CanBeClearedDuringGeneration = Factory.CreateBoolSet(1 != 0, 396, 400, 401, 397, 398, 399, 404, 368, 367);
            ...
            public static bool[] BlocksStairsAbove = Factory.CreateBoolSet(new int[2] { 386, 387 });
            ...
            public static bool[] FramesOnKillWall = Factory.CreateBoolSet(240, 241, 242, 245, 246, 4, 136, 334, 132, 55, 395);
            public static bool[] AvoidedByNPCs = Factory.CreateBoolSet(21, 55, 85, 395, 88, 334, 29, 97, 99, 356);
            public static bool[] InteractibleByNPCs = Factory.CreateBoolSet(17, 77, 133, 12, 26, 35, 36, 55, 395, 21, 29, 97, 88, 99, 33, 372, 174, 49, 100, 173, 78, 79, 94, 96, 101, 50, 103, 282, 106, 114, 125, 171, 172, 207, 215, 220, 219, 244, 228, 237, 247, 128, 269, 354, 355, 377, 287, 378, 390, 302, 405, 406, 411);
